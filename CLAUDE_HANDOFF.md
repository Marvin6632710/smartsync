...
| More noticeable “Current Warnings” in Settings | **Done 2026-09-21.** Its own card under the preferences (`.warnings-card`), titled "Current warnings", icon in a tile, live count from `useMyWarnings`; amber card + count pill when there is anything on the record; never claims a clean record while loading or after an error. |
