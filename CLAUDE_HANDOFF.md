...
Verification at this point: **952 unit/app, 402 rules, 8 Auth/Firestore
integration, 11 push-delivery and 3 push-trigger tests pass**. Lint, formatting,
Maps configuration and the production build are clean. The seeded browser
walkthrough of the new admin and user appeal surfaces is complete; no destructive
action was submitted. Production lists all six new Functions, rules released,
and the signed-in live `/admin` dashboard shows Appeals and Recent
announcements. Served JS/CSS checksums match the local build.
